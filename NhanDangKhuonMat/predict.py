...
path = "./NhanDangKhuonMat/image"
mydict = os.listdir(path)
...
def run():
    ...
    # cap = cv.VideoCapture('./video/ThayDuc02.mp4')
    ...
    while True:
        ...
        if faces[1] is not None:
            ...
            cv.putText(frame,result,(1,50),cv.FONT_HERSHEY_SIMPLEX, 0.5, (255,238,122), 2)
